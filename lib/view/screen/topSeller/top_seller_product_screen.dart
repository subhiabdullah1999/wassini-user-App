...
class TopSellerProductScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    print('====Top seller Name=====>${topSeller.name} ========id =====>${topSeller.id}');
    ...
    Provider.of<ProductProvider>(context, listen: false).initSellerProductList(topSeller.id.toString(), 1, context);
